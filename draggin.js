      ...
      if(!editing){
          ...
          document.addEventListener('mousemove',function(e) {
            ...
            if(moving === true){
              ...
              //console.log(tgt)
              //console.log(tgt.style.width)
              //width: 90.8px; height: 79.2px;
              var position = 'transform: translate('+dx+'px, '+dy+'px);z-index:'+z+';width: ' + tgt.style.width + '; height: ' + tgt.style.heigth + ';';
